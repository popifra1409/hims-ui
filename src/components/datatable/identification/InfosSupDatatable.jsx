...
import { infosSupColumns } from '../../../scenes/pages/identification/infossup/infosSupDatatableSource';
...
const PatientDatatable = () => {
  ...
  return (
    <Box m="20px">
    <Header title="INFOSSUP DU PATIENT"/>
    <Box
    m="40px 0 0 0"
    height="75vh"
    sx={{"& .MuiDataGrid-root":{
    ...
    >
       ...
       <Link to="/identification/singlepatient" style={{ textDecoration: "none" }}>
        ...
        <DataGrid
         rows={mockDataTeam}
         columns={infosSupColumns.concat(actionColumn)}
