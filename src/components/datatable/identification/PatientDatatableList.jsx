...
import { patientColumns } from '../../../scenes/pages/identification/patient/patientDatatableSource';
...
const PatientDatatable = () => {
            ...
            return (
              <div className="cellAction">
                <div className="actionButtons">
                  ...
                  <Link to="/identification/singlepatient" style={{ textDecoration: "none" }}>
  ...
  return (
    <Box m="20px">
    <Header title="GESTION DU PATIENT"/>
    <Box
    m="40px 0 0 0"
    height="75vh"
    sx={{"& .MuiDataGrid-root":{
    ...
    >
       <Box>
       <Link to="/identification/newpatient" style={{ textDecoration: "none" }}>
          <Button
            sx={{
              backgroundColor: colors.BlueAccent[700],
